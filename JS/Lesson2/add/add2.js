...
//     console.log(num[1])
// } else {
//     console.log('не вірна послідовність цифр')
// }
...
// num >= -100 && num < 0 ? alert('негативне число') : num === 0 ? alert('число 0') : num > 0 && num <=100 ? alert('позитивне число') : alert('щось не то ввів');