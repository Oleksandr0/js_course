...
for (const course of coursesArray) {
    ...
    let modulesDuration = document.createElement('div');
    modulesDuration.style.display = 'flex';

    let monthDurationElement = document.createElement('div');
    monthDurationElement.innerText = course.monthDuration;
    monthDurationElement.style.paddingRight = '20px';

    let hourDurationElement = document.createElement('div');
    hourDurationElement.innerText = course.hourDuration;
    modulesDuration.appendChild(monthDurationElement);
    modulesDuration.appendChild(hourDurationElement)
    ...
    courseElement.appendChild(modulesDuration)
