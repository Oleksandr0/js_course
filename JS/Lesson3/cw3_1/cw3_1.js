...
// document.write(`<div class="product-card2">`)
//
// for (const product of products) {
//     document.write(
//         `<div>
//             <h3 class="product-title2">${product.title}. Price - ${product.price} грн.</h3>
//             <img src="${product.image}" alt="image" class="product-image2">
//         </div>`)
// }
// document.write(`</div>`)
